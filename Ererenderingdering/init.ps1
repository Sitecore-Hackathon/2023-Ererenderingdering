...
try {
    ...
    & $mkcert -install
    & $mkcert "*.ererenderingdering.localhost"
...
Add-HostsEntry "cm.ererenderingdering.localhost"
if ($Topology -ne "xp0") {
  Add-HostsEntry "cd.ererenderingdering.localhost"
}
Add-HostsEntry "id.ererenderingdering.localhost"
Add-HostsEntry "www.ererenderingdering.localhost"
...
if ($InitEnv) {
    ...
    # CM_HOST
    Set-EnvFileVariable "CM_HOST" -Value "cm.ererenderingdering.localhost"

    if ($Topology -ne "xp0") {
      # CD_HOST
      Set-EnvFileVariable "CD_HOST" -Value "cd.ererenderingdering.localhost"
    }

    # ID_HOST
    Set-EnvFileVariable "ID_HOST" -Value "id.ererenderingdering.localhost"

    # RENDERING_HOST
    Set-EnvFileVariable "RENDERING_HOST" -Value "www.ererenderingdering.localhost"
