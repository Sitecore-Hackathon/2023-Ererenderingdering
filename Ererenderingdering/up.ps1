...
if ($ByPass) {
  dotnet sitecore login --cm https://cm.ererenderingdering.localhost/ --auth https://id.ererenderingdering.localhost/ --allow-write true --client-id "SitecoreCLIServer" --client-secret "testsecret" --client-credentials true
}else {
  dotnet sitecore login --cm https://cm.ererenderingdering.localhost/ --auth https://id.ererenderingdering.localhost/ --allow-write true
}
...
Start-Process https://cm.ererenderingdering.localhost/sitecore/
Start-Process https://www.ererenderingdering.localhost/
